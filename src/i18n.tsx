...
const translations: Record<AppLanguage, Record<string, string>> = {
  en: {
    ...
    "settings.commitMessageTimeoutHint": "Timeout in seconds when AI generates commit messages",
    "settings.commitMessageTimeoutInvalid": "Commit message timeout must be at least 1 second.",
  ...
  zh: {
    ...
    "settings.commitMessageTimeoutHint": "AI 生成提交信息时的超时时间，单位：秒",
    "settings.commitMessageTimeoutInvalid": "提交信息生成超时必须至少为 1 秒。",
